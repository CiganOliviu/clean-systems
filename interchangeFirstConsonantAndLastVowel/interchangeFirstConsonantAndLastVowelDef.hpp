...
private:
  ...
  int getPositionLastVowel (oneDimensionalArrayType<char> dataWorkFlow);
  int getPositionFirstConsonant (oneDimensionalArrayType<char> dataWorkFlow);

  void interchangeValues (char * parameterOne, char * parameterTwo);

public:
  stringWorkFlow () {}

  void interchangeFirstConsonantAndLastVowel (oneDimensionalArrayType<char> dataWorkFlow);
