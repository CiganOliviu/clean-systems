/*
  Tasks
    * Get minimum sum sequence in one dimensional array
*/
...
class getMinimumSumSequence {
private:
  validationRules __validations__;

public:
  getMinimumSumSequence () {}

  template<class Type> Type getMinimumSumSequenceODA (oneDimensionalArrayType<Type> ODARefference);

  virtual ~getMinimumSumSequence () {}
};
