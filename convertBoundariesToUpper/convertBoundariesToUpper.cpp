#include "convertBoundariesToUpperDef.hpp"
...
void stringWorkFlow::convertToUpperCase (oneDimensionalArrayType<char> dataWorkFlow) {
  ...
  int lastElement = strlen(dataWorkFlow.oneDimensionalArray) - 1;
  
  convertElementToUpper (dataWorkFlow.oneDimensionalArray[0]);
  convertElementToUpper (dataWorkFlow.oneDimensionalArray[lastElement]);
