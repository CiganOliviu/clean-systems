#include "deleteConsonantsFromStringDef.hpp"
...
void stringWorkFlow::deleteConsonantsFromString (oneDimensionalArrayType<char> dataWorkFlow) {
...
int main (int argc, char const *argv[]) {
  ...
  workflow.deleteConsonantsFromString (string);
