...
private:
  ...
  bool isNotVowel (char element);
  int returnPositionOfLastConsona (oneDimensionalArrayType<char> dataWorkFlow);

public:
  stringWorkFlow () {}

  void deleteLastConsonaFromArray (oneDimensionalArrayType<char> dataWorkFlow);
